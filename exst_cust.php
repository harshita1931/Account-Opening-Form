...
$(document).ready(function(){
    ...
    $("#2nd_button_skip").click(function(){
        $("#1st_part").hide();
        $("#2nd_part").hide(1000);
        $("#3rd_part").show(1000);
        $("#4th_part").hide();
...
<body background="background.jpg">
	<form action="thankyou_exst.php" id="acc_type" method="post">
		<div id = "1st_part">
		...
		<input type="radio" name="acc_type" value="saving_acc" required> Savings Account
	  	...
	  	*Branch Name :
	  	...
	  	<div id="2nd_part">
	  		<h3>Please mention the Customer Identification Number :</h3>
		<table> 
		<tr>	
			<td>Customer ID: </td>
		...
		<!-- <tr>
			<td>2nd Appl Cust ID:</td>
			<td><input type="text" name="CIN2"></td>
		</tr>
		<tr>
			<td>3rd Appl Cust ID:</td>
			<td><input type="text" name="CIN3"></td>
		</tr> -->
		</table>
		<br>
		<hr>
		<!-- <h3>Preferred time for delivery of Welcome Kit :</h3>
		<input type="radio" name="kit_time" value="anytime" required> Anytime during the day 
		<input type="radio" name="kit_time" value="7to9am"> 7am to 9am
		<input type="radio" name="kit_time" value="10to6">10am to 6pm
		<input type="radio" name="kit_time" value="7to9pm"> 7pm to 9pm
		<br>
		<br>
		<hr> -->

		If you <b>DO NOT</b> wish to update the address for the primary applicant, click on this submit button : <button id="2nd_button_skip">Next</button>
		<br>
		<hr>
		<b>If you wish to update the address for the primary applicant :</b> <br>
		<br>
		<br>
		<table>
			<tr>
